        ...
        <div class="container">
            <div class="row py-1 d-flex justify-content-md-around">
                ...
                <div class="d-none d-lg-flex col-lg-4 justify-content-center align-items-center p-2 text-white">
                    ...
                    <p class="my-auto ml-3">Av. Luiz Gonzaga Nascimento, 0 - Jd. Paulista<br/>Monte Mor/SP</p>
                </div>
                ...
                <div class="d-flex col-12 col-md-6 col-lg-4 justify-content-center align-items-center p-2 text-white mx-auto">
                    ...
                    <p class="my-auto ml-3">contato@minhaimob.com.br<br/>+55 (19) 3322-1234</p>
                </div>
    ...
    <nav class="navbar navbar-expand-md navbar-light my-3">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar">
                <ul class="navbar-nav">
                    <li class="nav-item"><a href="{{ route('web.home') }}" class="nav-link">Inicio</a></li>
...
<div class="main_copyright py-3 bg-front text-white text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="mb-0">Imobiliária | CRECI 1234 | Av. Luiz Gonzaga Nascimento, 0 - Monte Mor/SP</p>
                <p class="mb-0">Todos os Direitos Reservados - Agência Malubo Digital ®</p>
            </div>
        </div>
    </div>
</div>
