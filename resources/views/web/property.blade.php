            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <a href="https://api.whatsapp.com/send?phone=+5519982867118&text=Olá, gostaria de ter mais informações sobre o imovel." class="btn btn-outline-success btn-lg btn-block icon-whatsapp mb-3">Converse com o Corretor!
                        </a>
                        ...
                        <div class="main_property_contact">
                            ...
                            <form action="{{ route('web.sendEmail') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-center text-front mb-0 mt-4 font-weight-bold">(19) 98286-7118</p>
                                </div>
                            </form>
                        </div>
